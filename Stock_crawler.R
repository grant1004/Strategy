...
a <- apply( stock_id_list, 1 , function(x){ 
...
Sys.sleep(60 * 80)  # 60 seconds/minute * 60 minutes/hour = 3600 seconds

GetUseTimes() 

print( "All stocks crawler done .")


## stockInfo = read_json( paste( "日線/", stock_id_list['代碼'][1,], ".json", sep="" ) ) 
## data <- fromJSON(paste( "日線/", stock_id_list['代碼'][1,], ".json", sep="" ))
